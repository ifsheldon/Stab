...
M8 sampling compatibility has started with deterministic `01`, `b8`, `r8`, `ptb64`, `hits`, and `dets` output for the parser-backed Z-basis subset plus seeded Z-basis noise sampling for `X_ERROR`, `Y_ERROR`, `Z_ERROR`, `I_ERROR`, `II_ERROR`, `DEPOLARIZE1`, `DEPOLARIZE2`, `PAULI_CHANNEL_1`, and `PAULI_CHANNEL_2`; broader simulator semantics and reference-sample behavior still belong to later M8 work.
