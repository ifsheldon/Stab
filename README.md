...
M8 sampling compatibility has started with deterministic `01`, `hits`, and `dets` output for the parser-backed Z-basis subset; noisy sampling, bit-packed result formats, and reference-sample behavior still belong to later M8 work.
