...
const EXPECTED_FROZEN_DIGEST: &str =
    "14614b21280044da7571243b7bb0d5a5e941edd5070999c2f08d98f6e3e923bc";
...
pub(crate) enum CorrectnessCommand {
    ...
    /// Regenerate the deterministic correctness inventory.
    Regenerate,
...
pub(crate) fn run(root: &RepoRoot, command: Command) -> Result<(), QualificationError> {
    ...
    match command {
        ...
        CorrectnessCommand::Regenerate => {
            let generated = inventory::generate(root)?;
            validation::validate(&generated, "UNFROZEN")?;
