...
const EXPECTED_LEDGER_DIGEST: [u8; 32] = [
    0x11, 0x09, 0x1e, 0x5b, 0xd4, 0x7d, 0xbb, 0xfb, 0x03, 0x5d, 0x1c, 0x23, 0x6a, 0x83, 0x29, 0x42,
    0x90, 0x27, 0x53, 0x40, 0xbe, 0x1e, 0x3f, 0x77, 0xe6, 0x0f, 0xbb, 0x86, 0xd7, 0x80, 0x4e, 0xa2,
];
