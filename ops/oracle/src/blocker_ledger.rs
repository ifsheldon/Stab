...
const EXPECTED_LEDGER_DIGEST: [u8; 32] = [
    0x0a, 0x59, 0x00, 0xb7, 0xfd, 0xa4, 0x5b, 0x9f, 0xe9, 0x3c, 0xc3, 0x8f, 0xf9, 0x2d, 0xa7, 0x22,
    0x19, 0xe2, 0x36, 0x05, 0xa9, 0xb0, 0x12, 0xcd, 0x2d, 0x9a, 0xdc, 0x06, 0x82, 0xea, 0xc3, 0x60,
];
