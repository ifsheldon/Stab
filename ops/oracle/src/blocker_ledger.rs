...
const EXPECTED_LEDGER_DIGEST: [u8; 32] = [
    0xcf, 0x69, 0x14, 0xdc, 0xf3, 0xd4, 0x1a, 0xc6, 0x94, 0xa0, 0x0b, 0x46, 0x7d, 0x77, 0xf7, 0x3e,
    0xde, 0xfe, 0x99, 0xe4, 0x7d, 0xc5, 0x72, 0x92, 0xa4, 0xf2, 0x24, 0x5c, 0xdd, 0x2c, 0x62, 0xf4,
];
