...
const EXPECTED_LEDGER_DIGEST: [u8; 32] = [
    0x11, 0xde, 0x1a, 0xe8, 0x83, 0xc3, 0x32, 0xb1, 0x45, 0x5b, 0xdd, 0x41, 0x89, 0x46, 0xa2, 0x66,
    0x18, 0x91, 0x57, 0x5a, 0x9f, 0xbc, 0x5c, 0xe4, 0xaa, 0x18, 0x71, 0x8d, 0x3d, 0xdf, 0x8a, 0xae,
];
