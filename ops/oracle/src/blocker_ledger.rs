...
const EXPECTED_LEDGER_DIGEST: [u8; 32] = [
    0x33, 0x85, 0x8e, 0x83, 0x48, 0x84, 0xd2, 0x2b, 0x0c, 0x60, 0xef, 0x5e, 0xee, 0xaa, 0x50, 0x3d,
    0x43, 0x19, 0x29, 0x61, 0x06, 0x20, 0x3a, 0xc0, 0xa9, 0xd4, 0x08, 0x45, 0xe5, 0x53, 0xeb, 0x78,
];
