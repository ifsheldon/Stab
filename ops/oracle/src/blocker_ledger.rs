...
const EXPECTED_LEDGER_DIGEST: [u8; 32] = [
    0x5a, 0x5a, 0x26, 0xcc, 0x2e, 0x34, 0xa5, 0xa3, 0xb2, 0xd9, 0x17, 0xb9, 0x94, 0xd3, 0x34, 0xb3,
    0xee, 0x66, 0x97, 0x1b, 0xcc, 0x04, 0x5e, 0xa1, 0x25, 0x50, 0x82, 0x71, 0xf1, 0x29, 0xe0, 0xff,
];
