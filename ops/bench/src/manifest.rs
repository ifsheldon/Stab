...
const REQUIRED_BENCHMARK_IDS: &[&str] = &[
    ...
    "m7-convert-01-to-b8",
    "m7-convert-b8-to-01",
    "m7-convert-b8-to-b8-wide",
    "m7-convert-dets-to-b8",
    "m7-convert-b8-to-dets",
    "m7-convert-ptb64-to-01",
    "m7-convert-01-to-ptb64",
    "m7-convert-circuit-dl-obs-out",
    "m7-convert-dem-dets-to-01",
...
mod tests {
    ...
    fn legacy_contract_named_rows_can_use_public_stim_cli_baselines() {
        ...
        for (id, expected_argv, expected_stdin) in [
            ...
            (
                "m7-convert-01-to-b8",
                "convert|--in_format=01|--out_format=b8|--bits_per_shot=128",
                "benchmarks/fixtures/convert_01_128.01",
            ),
            (
                "m7-convert-b8-to-01",
                "convert|--in_format=b8|--out_format=01|--bits_per_shot=128",
                "benchmarks/fixtures/convert_b8_128.b8",
            ),
            (
                "m7-convert-b8-to-b8-wide",
                "convert|--in_format=b8|--out_format=b8|--bits_per_shot=2048",
                "benchmarks/fixtures/convert_b8_2048.b8",
            ),
            (
                "m7-convert-dets-to-b8",
                "convert|--in_format=dets|--out_format=b8|--num_detectors=64|--num_observables=8",
                "benchmarks/fixtures/convert_dets_dl_72.dets",
            ),
            (
                "m7-convert-b8-to-dets",
                "convert|--in_format=b8|--out_format=dets|--num_detectors=64|--num_observables=8",
                "benchmarks/fixtures/convert_b8_dl_72.b8",
            ),
            (
                "m7-convert-ptb64-to-01",
                "convert|--in_format=ptb64|--out_format=01|--bits_per_shot=128",
                "benchmarks/fixtures/convert_ptb64_128.ptb64",
            ),
            (
                "m7-convert-circuit-dl-obs-out",
                "convert|--in_format=01|--out_format=dets|--circuit=benchmarks/fixtures/convert_circuit_dl.stim|--types=DL|--obs_out=target/benchmarks/cli-scratch/m7-convert-circuit-dl-obs-out.obs.b8|--obs_out_format=b8",
                "benchmarks/fixtures/convert_dl_72.01",
            ),
            (
                "m7-convert-dem-dets-to-01",
                "convert|--in_format=dets|--out_format=01|--dem=benchmarks/fixtures/convert_dem_dl.dem",
                "benchmarks/fixtures/convert_dets_dl_72.dets",
            ),
            (
                "m11-sample-dem-sparse-contract",
