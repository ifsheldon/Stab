...
pub(super) fn render(
    ...
    let contract_preflight = code(&report.workers.contract_preflight_sha256);
    ...
    Ok(format!(
        ...
        stab_commit,
        contract_preflight,
        report.contract_preflight.probe_count(),
        ...
        batch_policy,
        common_batch_mode,
        report.calibration.stim.selected_iterations,
        report.calibration.stab.selected_iterations,
        report.calibration.common_iterations,
