...
impl WorkerWorkload {
    pub(super) fn id(self) -> &'static str {
        match self {
            ...
            Self::CircuitModelFingerprint => "circuit-model-fingerprint",
            Self::SamplingRequestFingerprint => "sampling-request-fingerprint",
            Self::SamplingRequestEstimate => "sampling-request-estimate",
            Self::SamplerCompile => "sampler-compile",
            Self::ExactMlCompile => "exact-ml-compile",
            Self::ExactMlReusedDecode => "exact-ml-reused-decode",
            Self::SampleDetectDecodePipeline => "sample-detect-decode-pipeline",
            Self::ExternalNoisePass => "external-noise-pass",
    ...
    pub(super) fn measurement_id(self) -> &'static str {
        match self {
            ...
            Self::ExactMlCompile => "compile-and-release",
            Self::ExactMlReusedDecode => "decode-batch",
            Self::SampleDetectDecodePipeline => "sample-detect-decode",
            Self::ExternalNoisePass => "run-and-release",
            Self::DemParse => "parse",
