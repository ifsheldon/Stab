...
const FLOW_GENERATOR_MEASUREMENT_CASES: usize = 21;
const FLOW_GENERATOR_MEASUREMENT_FLOWS: usize = 77;
...
pub(super) fn compare_note(row_id: &str) -> Option<&'static str> {
    match row_id {
        "pf5-flow-generators-measurement-rich" => Some(
            "report-only: Stab measures the Rust circuit_flow_generators scoped measurement/reset/pair-measurement/MPP/feedback/MPAD/heralded-noise subset without a faithful pinned Stim CLI timing ratio",
        ),
