...
- Use `just bench::qualification-probe --group pq1-process-contract-smoke` and `just bench::qualification-probe --group pq1-adapter-protocol-smoke` to reproduce the bounded process and pinned-Stim adapter contracts independently.
