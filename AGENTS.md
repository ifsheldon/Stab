...
- Use existing namespaced recipes such as `rust::clippy`, `oracle::run`, `bench::smoke`, and `maintenance::pre-commit` instead of a growing flat command list.
