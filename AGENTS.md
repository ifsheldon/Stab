...
- CQ1 and PQ1 are complete at the clean evidence recorded in `docs/plans/cq1-correctness-harness-progress-report.md` and `docs/plans/pq1-performance-harness-progress-report.md`; CQ2 is active, and later work must preserve both receipt, preflight, toolchain, and report validity contracts.
