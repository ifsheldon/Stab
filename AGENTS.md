...
- CQ1 and PQ1 harness acceptance is recorded in `docs/plans/cq1-correctness-harness-progress-report.md` and `docs/plans/pq1-performance-harness-progress-report.md`; CQ2 is active, and any correctness or performance inventory digest change makes those clean runs historical until the affected tiers are rerun from a clean committed revision.
