...
The two DEM groups are executable harness contracts only until their clean correctness prerequisite, reproducible-worker check, probes, full and soak reports, regressions, rollups, completion receipts, and focused legacy migration all pass; no DEM ratio is current evidence yet.
