...
Private Stab build-receipt schema version 5 hashes the ordered framed collection of every executable worker source from the materialized commit, including the prepared-workload lifecycle and Clifford-string worker.
Adapter receipt schema version 11, contract-preflight schema version 12, and qualification report schema version 31 retain 212 accepted or rejected worker receipts and exact worker identities for offline replay.
