...
Private Stab build-receipt schema version 4 hashes the ordered framed collection of every executable worker source from the materialized commit, including the Clifford-string worker.
Adapter receipt schema version 11, contract-preflight schema version 11, and qualification report schema version 30 retain 202 accepted or rejected worker receipts and exact worker identities for offline replay.
