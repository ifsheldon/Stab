...
> Source-current note, 2026-07-18: this report retains CQ0 completion-era counts and evidence below. Strengthening the dedicated Pauli iterator owner sets the source-current schema-version-3 digest to `4c940e983df10a7c95cc512939f4a0cce79f1865e141739af9378db581ea5f87`, with 1,972 default-feature public Rust API items and 1,744 evidence parents: 580 implemented, 17 evidence-close, and 1,147 planned. Core revision `8503f458eac09fe94dba54cf8d6e16e88e195df4` adds the independent exact iterator corpus, clean evidence revision `afaf0bf7f236b9f6ae6f72c19bbbdfea94d26632` publishes its exact three-case correctness prerequisite after complete accepted-maximum traversal strengthening, and clean revision `6351fe0a529462efd9f18a88bd59c08cfec9f81b` passes the latest complete historical 145-case PR subset and 271-case full and soak CQ2 selections. Controller hardening at `763b04055f969668a4152e019ed62a3555cd0476` makes a fresh source-current all-domain rerun necessary. See `docs/plans/cq2-deterministic-qualification-progress-report.md`.
