...
> Source-current note, 2026-07-17: this report retains CQ0 completion-era counts and evidence below. Strengthening the direct non-identity Pauli multiplication owner and its exhaustive basis, sign, and word-boundary corpus sets the source-current schema-version-3 digest to `a739d350eeb3455d4a0b386f8a257d3d4fe01d417d7d11d8a269229d68a6a103`, with 1,972 default-feature public Rust API items and 1,744 evidence parents: 580 implemented, 17 evidence-close, and 1,147 planned. Clean revision `cd1e33e10f45995ccaca498547ff5aa88bfe51bb` published and replayed the exact strengthened two-case Pauli prerequisite, while earlier broad CQ2 reports remain historical under their recorded digests and the complete 271-case CQ2 family still must run before citing all-domain execution as source-current. See `docs/plans/cq2-deterministic-qualification-progress-report.md`.
