...
> Source-current note, 2026-07-23: this report retains CQ0 completion-era counts and evidence below. The current source state sets the schema-version-3 digest to `592934174f3cf248553d3df67078ec00563e48acfd4c5ddf15cef44fd9b49fd0`, with 2,065 default-feature public Rust API items and 1,757 evidence parents: 593 implemented, 17 evidence-close, and 1,147 planned. The result-format and CLI repair adds strict grammar, typed DETS, bounded text-line, streaming-prefix, and file-role owners; those source-current owners remain reopened pending clean-revision execution. Clean revision `3f2f382627c8421de0a668819d467a9f252de20f` remains accepted historical all-domain evidence under preceding digest `4c940e983df10a7c95cc512939f4a0cce79f1865e141739af9378db581ea5f87`, but the source-current inventory has no all-domain execution claim. Every dependent timing revision must generate its focused prerequisite from the same clean source state. See `docs/plans/cq2-deterministic-qualification-progress-report.md`.
