...
> Source-current note, 2026-07-23: this report retains CQ0 completion-era counts and evidence below. The current reviewed source state sets the schema-version-3 digest to `17d736fcbeed5b98e6ef04c1d5dee75dfde833259cd345bf40efd44ed2961942`, with 1,986 default-feature public Rust API items and 1,744 evidence parents: 580 implemented, 17 evidence-close, and 1,147 planned. The twelve added API records are `DemRepeatCount`, its two methods, and nine derived trait implementations; the exact DEM model mutation/repeat case owns them and now distinguishes zero-capable DEM repeats from nonzero circuit repeats. Clean revision `3f2f382627c8421de0a668819d467a9f252de20f` remains accepted historical all-domain evidence under preceding digest `4c940e983df10a7c95cc512939f4a0cce79f1865e141739af9378db581ea5f87`, but the source-current inventory has no all-domain execution claim. Every dependent timing revision must generate its focused prerequisite from the same clean source state. See `docs/plans/cq2-deterministic-qualification-progress-report.md`.
