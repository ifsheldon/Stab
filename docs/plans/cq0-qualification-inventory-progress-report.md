...
> Source-current note, 2026-07-18: this report retains CQ0 completion-era counts and evidence below. Strengthening the dedicated Pauli iterator owner sets the source-current schema-version-3 digest to `4c940e983df10a7c95cc512939f4a0cce79f1865e141739af9378db581ea5f87`, with 1,972 default-feature public Rust API items and 1,744 evidence parents: 580 implemented, 17 evidence-close, and 1,147 planned. Core revision `8503f458eac09fe94dba54cf8d6e16e88e195df4` adds the independent exact iterator corpus, and clean evidence revision `afaf0bf7f236b9f6ae6f72c19bbbdfea94d26632` publishes its source-current exact three-case correctness prerequisite after complete accepted-maximum traversal strengthening. The complete 271-case CQ2 run remains pending. Earlier focused and broad CQ2 reports remain historical under their recorded digests. See `docs/plans/cq2-deterministic-qualification-progress-report.md`.
