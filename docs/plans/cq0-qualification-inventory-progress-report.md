...
> Source-current note, 2026-07-16: this report retains CQ0 completion-era counts and evidence below. The exact Stim v1.16.0 gate-name hash owner sets the source-current schema-version-3 digest to `ccb80eb4b660a375b59460c3b7fa03a810abd6f868735b566735378105db22b2`, with 1,972 default-feature public Rust API items and 1,744 evidence parents: 580 implemented, 17 evidence-close, and 1,147 planned. The clean all-domain reports from revision `bae9e01cb3fedaf9d37958e6827b064c635b9898` and the focused parser/printer report from revision `ba70a52025fdd4122ac97cec263725b2ec56e431` remain historical under the refreshed digest. The exact gate-hash prerequisite passed clean current-digest execution and preflight at revision `c76b7071fc4d7ac358ef3a2fffc053ea675bd05f`; rerun the complete 271-case CQ2 family before citing all-domain execution as source-current. See `docs/plans/cq2-deterministic-qualification-progress-report.md`.
