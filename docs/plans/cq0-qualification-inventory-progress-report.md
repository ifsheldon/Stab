...
> Source-current note, 2026-07-23: this report retains CQ0 completion-era counts and evidence below. The current reviewed source state sets the schema-version-3 digest to `e5635ca4a2c217ee79768d35336c50611a9f12f86edded8a7f01fce1ca72add4`, with 1,974 default-feature public Rust API items and 1,744 evidence parents: 580 implemented, 17 evidence-close, and 1,147 planned. The second DEM parser optimization moved the same 108 rustdoc source lines without changing any public API path, owner, selector, disposition, case ID, or count. Packed Clifford review-fix revision `9c672ef3c12c3fe68632e8609a58ae98714bc144` remains implementation history under preceding digest `c50f27fd097ac870c987d1f91c44d9e6a75510ed4d51ec44853dbc328f0b1fa7`; it is not the producer of the current digest. Clean revision `3f2f382627c8421de0a668819d467a9f252de20f` remains accepted historical all-domain evidence under preceding digest `4c940e983df10a7c95cc512939f4a0cce79f1865e141739af9378db581ea5f87`, and focused revision `ac20ffca` remains historical three-case evidence under preceding digest `c50f27fd097ac870c987d1f91c44d9e6a75510ed4d51ec44853dbc328f0b1fa7`; every dependent timing revision must generate its focused prerequisite from the same clean source state. See `docs/plans/cq2-deterministic-qualification-progress-report.md`.
