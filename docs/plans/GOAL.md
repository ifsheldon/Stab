...
Program checkpoint: CQ0 is current at correctness inventory digest `d4e35f2cd834ea51a67c2ef5229d1788ae03a7c8607a9424c900fae073ab8a56`; PQ0 is dependency-regenerated at performance inventory digest `2be8a478a5767e7be46881b01473600d456a9af52c6078b14abdc4fc09773243`. The previously clean CQ1 PR 331/331, full 493/493, and soak 493/493 reports and the corresponding PQ1 schema-version-13 reports remain historical evidence for the preceding result-format digest, but they are not promotable evidence for the current gate-refined digests. Regenerate clean current-digest CQ1 and PQ1 reports after committing the gate checkpoint.
