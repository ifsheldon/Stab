...
Program checkpoint: CQ0 is current at correctness inventory digest `f30a56853dbc9334d1ba91a400da3a40c108d4ee2aa748d4edc9a5662093ba11`; PQ0 is dependency-regenerated at performance inventory digest `4ebbf8bc85ebeb722fcf3e9eefa4796b57ba61b2773fa64eef37e70dca41a744`. Clean current-digest correctness evidence from revision `1eaf3740c5819271be30a37ce4b6f69e2010a2ba` passes CQ1 PR 354/354, full 527/527, and soak 527/527, offline report validation, and exact Circuit repetition-owner preflight. The dependent report-only PQ1 refresh for the new performance digest must run from the clean documentation-and-inventory commit before it is cited as current evidence.
The active milestone is CQ2: qualify deterministic models, formats, gates, bit kernels, circuit APIs, generation, and stabilizer algebra at exact case and exported-API granularity before PQ2 times those surfaces. The selected `.stim`, `.dem`, result-format, gate-contract, bit-kernel, and circuit-API domains are complete with 29, 28, 39, 59, 12, and 24 implemented evidence parents respectively and zero planned owners. The Circuit slice comprises twenty focused qualification parents and four exact PF1 fixture parents; it assigns all 185 selected exported Rust API items, dispositions all 109 relevant pinned-upstream records, preserves 60 Python product deferrals, and documents checked Rust `Result` overflow instead of claiming C++ `UINT64_MAX` saturation parity. CQ2 now has 204 implemented owners and 710 planned owners across 914 selected owners. Continue with `CQ-GENERATION`, where 75 of 87 owners remain planned, then `CQ-ALGEBRA`, where 635 of 636 remain planned.
