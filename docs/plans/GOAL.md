...
Program checkpoint: CQ0 is current at correctness inventory digest `1152e9fa36d55c8a5a2282638fbc8ad79a39e7b4456161fba868a15c45cfb16e`; PQ0 is dependency-regenerated at performance inventory digest `3b762ed4bcd44157fb5c7410912a30fb6fc7abb4ff69ab95a38ef9892c72bec6`. CQ1 refresh evidence from revision `ec1ae89e1ae42be92f87d13cbe15cc3aacdfcb77` passes PR 302/302, full 441/441, and soak 441/441. The PQ1 reports from that revision remain valid historical diagnostic evidence for the preceding performance digest; rerun PQ1 after this source-owned documentation checkpoint is committed because the corrected checklist rows changed the dependent performance digest.
The active milestone is CQ2: qualify deterministic models, formats, gates, bit kernels, and stabilizer algebra at exact case and exported-API granularity before PQ2 times those surfaces. The completed `.stim`-format slice has 32 implemented evidence parents and zero planned owners: 24 qualification parents map 44 exact upstream owners and nine exported-API owners, while eight independently selected oracle-fixture parents remain direct evidence. Two additional instruction-semantic parents close two upstream `CircuitInstruction` cases and four exact Rust methods without claiming Stim-incompatible circuit-count overflow behavior or untested derived traits. CQ2 remains incomplete with 2,410 planned evidence owners, so continue with `.dem` format qualification instead of treating this slice as CQ2 completion.
