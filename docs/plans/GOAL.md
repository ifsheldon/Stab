...
Program checkpoint: CQ0 is current at correctness inventory digest `4ee9686104c0d537073a823986cb71b8bc092c7a9f09fbdbee75c4af7d2c6b70`; PQ0 is dependency-regenerated at performance inventory digest `9ae9b79c172c27f2a33475d856cca97c668c6608781cb81b8a8861f46cd13966`. Clean global CQ1 evidence from revision `c6ca93945ad7e94e758e2cdea745a9b2a62c401a` passes PR 336/336, full 501/501, and soak 501/501 with offline report regeneration and exact PR/full/soak gate-parent preflight. Current-digest PQ1 schema-version-13 PR, full, and soak reports from the same revision are clean, host-verified, pass report-only regression replay, and remain diagnostic infrastructure evidence rather than product performance.
The active milestone is CQ2: qualify deterministic models, formats, gates, bit kernels, and stabilizer algebra at exact case and exported-API granularity before PQ2 times those surfaces. The selected `.stim`, `.dem`, result-format, and gate-contract domains are complete with 32, 28, 39, and 59 implemented evidence parents respectively and zero planned owners. The gate slice comprises 37 reused blocker-ledger parents, 14 direct oracle-fixture parents, and eight focused qualification parents; it dispositions all 540 relevant upstream records, including 200 explicitly deferred simulator or Python rows, and assigns all 178 selected exported Rust API items without duplicating canonical selectors. CQ2 now has 215 implemented owners and 1,419 planned owners across 1,634 selected owners, so continue with `CQ-BIT-KERNELS`, where 384 of 388 owners remain planned.
