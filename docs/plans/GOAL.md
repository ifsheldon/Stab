...
Program checkpoint: CQ0 is current at correctness inventory digest `5d1fc9d21e511e13bef5ceb476dbcf9dd20ed067339edd2891013992fb06ced5`; PQ0 is dependency-regenerated at performance inventory digest `a7177e298b5e1f05979b871704514fdf2650070a7c48e5d72c6fb48bb80d13bf`. CQ1 refresh evidence from revision `add37ccb6dc52b0ac96b37397f6b012de0bcd6a4` passes PR 300/300, full 429/429, and soak 429/429; current-digest PQ1 schema-version-13 PR, full, and soak reports from the same revision are clean, host-verified, and report-only.
The active milestone is CQ2: qualify deterministic models, formats, gates, bit kernels, and stabilizer algebra at exact case and exported-API granularity before PQ2 times those surfaces. Its first `.stim`-format slice maps 41 exact source owners onto 19 independently selectable qualification parents. CQ2 remains incomplete with 2,463 planned evidence owners, so continue domain work instead of treating the clean harness refresh as feature completion.
