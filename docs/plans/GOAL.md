...
5. In progress: circuit sampling is extracted into `stab-engine`; move detection conversion and detection sampling next, then DEM sampling, reference-sample trees, and sampled-flow execution without changing facade or CLI behavior.
