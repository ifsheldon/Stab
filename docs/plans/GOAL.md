...
Program checkpoint: CQ0 is source-current at correctness inventory digest `ad4b927cbc8cbbca2b9279b728f76dd72d22f7118cae5f754f025dc0ba4fd519`; PQ0 is dependency-regenerated at performance inventory digest `229b4bf24aadfe92b6a576421a63fb795328cca9d3cc89dd03010b20c0dc977f`. The previous clean correctness and dependent PQ1 reports from revision `d0ecafd62794daad0ab5eb63d54c481a5e32a30b` remain historical Generation-checkpoint evidence because the Algebra ownership correction changed both frozen digests. Their 1.014015, 1.015160, and 1.015225 median ratios measure only the synthetic adapter protocol and are not Stab product-performance evidence. Publish new clean reports only after the Algebra slice has exact parents and passes audit and review.
The active milestone is CQ2: qualify deterministic models, formats, gates, bit kernels, circuit APIs, generation, and stabilizer algebra at exact case and exported-API granularity before PQ2 times those surfaces. The selected `.stim`, `.dem`, result-format, gate-contract, bit-kernel, circuit-API, and Generation domains are source-complete and accepted with 29, 28, 39, 59, 12, 24, and 25 implemented evidence parents respectively and zero planned owners. The Generation slice assigns all 107 selected exported Rust API items, dispositions all 15 relevant pinned-upstream records, preserves the Python `Circuit.generated` string-dispatch symbol as one product deferral, and adds exact family, parameter, no-noise matrix, helper, and pre-allocation resource contracts. The reviewed Algebra classifier now selects 217 portable upstream records, explicitly defers 139 product records, rejects unexposed C++ helpers as not applicable, and assigns 604 exported Rust API items, including Flow value objects. CQ2 now has 217 implemented owners and 453 planned owners across 670 selected owners. The active implementation blocker is `CQ-ALGEBRA`, where 453 of 454 owners remain planned; its deterministic materialization limits must be resolved before acceptance.
