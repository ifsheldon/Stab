...
Program checkpoint: CQ0 is current at correctness inventory digest `2b2f0456e568b86a973d4b9077b9688ab9f7748af1bd9cd349e2a2abf217d638`; PQ0 is dependency-regenerated at performance inventory digest `4e31a348b0c796ae4c4400369c70019eff8fa991592f201c80e7fee7d8718f7a`. The latest clean global CQ1 and PQ1 evidence remains revision `c6ca93945ad7e94e758e2cdea745a9b2a62c401a` for the preceding gate-refined digest; it is historical until a committed current-digest PR, full, and soak refresh passes offline report validation, exact case preflight, and report-only PQ1 regression replay.
The active milestone is CQ2: qualify deterministic models, formats, gates, bit kernels, and stabilizer algebra at exact case and exported-API granularity before PQ2 times those surfaces. The selected `.stim`, `.dem`, result-format, gate-contract, and bit-kernel domains are complete with 32, 28, 39, 59, and 12 implemented evidence parents respectively and zero planned owners. The bit slice comprises eight focused qualification parents and four exact M5 fixture parents; it assigns all 274 selected exported Rust API items, selects 82 portable upstream semantic records, and explicitly dispositions 168 C++-specific storage, lane, aliasing, resizing, arithmetic, shift, raw-randomization, table, and mutable-range records as not applicable. CQ2 now has 223 implemented owners and 1,035 planned owners across 1,258 selected owners. First publish clean current-digest evidence for the bit checkpoint, then continue with `CQ-CIRCUIT-API`, where 325 of 362 owners remain planned.
