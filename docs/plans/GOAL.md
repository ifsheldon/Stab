...
Program checkpoint: CQ0 is source-current at correctness inventory digest `ccb80eb4b660a375b59460c3b7fa03a810abd6f868735b566735378105db22b2`, with 2,886 upstream records, 1,972 default-feature public Rust API items, and 1,744 evidence parents. Of those parents, 580 are implemented, 17 are evidence-close, and 1,147 remain planned for later qualification. PQ0 and the first four PQ2 product contracts are source-current at performance inventory digest `9be7dea23a221e9d7fe6ba2e9bdfaf65ad2b4a7675b557386b3de6ea58306557`; `PERFQ-M4-CIRCUIT-PARSE`, `PERFQ-M4-CIRCUIT-CANONICAL-PRINT`, `PERFQ-M4-GATE-LOOKUP`, and `PERFQ-M5-SIMD-WORD` are graduated to implemented exact runtime groups. The popcount group binds three exact bit-kernel CQ owners, identical little-endian SplitMix64 fixtures at three aligned scales, and an exact `1.25x` median and upper-confidence-bound target with no waiver. Clean popcount evidence is pending. The first three groups' passing AArch64 reports remain historical after the global performance inventory and shared workers changed. Setup and peak RSS remain report-only observations until PQ6 defines a machine-checked growth rule. The legacy canonical-printer row is superseded and its M12 beta, timing-regression, and memory waivers are retired; the legacy `m5-simd-word` M12 threshold remains active until explicit replacement migration. No threshold or comparator fidelity rule was relaxed.
