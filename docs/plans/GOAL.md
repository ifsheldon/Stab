...
PFM-B4 is now the active milestone. Evidence-close the selected detecting-region and missing-detector cases, split their shared selectors, replace the remaining exhaustive flow solver with general GF(2) elimination, and establish shared stabilizer transitions before starting PFM-B1; do not reopen PFM-B0, PFM-B2 contract groundwork, or PFM-B3 unless their frozen contracts change.
