...
Select the next finite dependency-ordered PQ2 runtime group from the remaining implemented deterministic surfaces before changing qualification ownership. Refactor any near-limit benchmark adapter, invocation, validation, or worker owner before an affected source reaches 1,200 lines.
