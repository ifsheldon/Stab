...
Program checkpoint: CQ0 is source-current at correctness inventory digest `d89a5f9eaba428fb72741c66ad74226820660e25e949123871c6c7ab86f82dd6`; PQ0 is dependency-regenerated at performance inventory digest `44276968d035fbd108fd57096dc96aed1d3967ac07d539a8dbfed8f0d5f16fcb`. The last clean correctness reports, from revision `1eaf3740c5819271be30a37ce4b6f69e2010a2ba`, passed CQ1 PR 354/354, full 527/527, and soak 527/527 for the preceding circuit-refined digest; they are historical evidence and must not be promoted under the current Generation-refined digest. The last dependent report-only PQ1 refresh from revision `eb6a6df8f48504239fbe7f640f924748b63617f2` is likewise historical until current-digest correctness and dependent reports are republished from a clean committed revision.
The active milestone is CQ2: qualify deterministic models, formats, gates, bit kernels, circuit APIs, generation, and stabilizer algebra at exact case and exported-API granularity before PQ2 times those surfaces. The selected `.stim`, `.dem`, result-format, gate-contract, bit-kernel, circuit-API, and Generation domains are source-complete with 29, 28, 39, 59, 12, 24, and 25 implemented evidence parents respectively and zero planned owners. The Generation slice assigns all 107 selected exported Rust API items, dispositions all 15 relevant pinned-upstream records, preserves the Python `Circuit.generated` string-dispatch symbol as one product deferral, and adds exact family, parameter, no-noise matrix, helper, and pre-allocation resource contracts. CQ2 now has 217 implemented owners and 635 planned owners across 852 selected owners. Generation audit, GPT-5.6/max full-code-review, and broad verification are complete with every confirmed finding fixed; publish clean current-digest PR/full/soak correctness evidence and the dependent PQ1 refresh, then continue with `CQ-ALGEBRA`, where 635 of 636 owners remain planned.
