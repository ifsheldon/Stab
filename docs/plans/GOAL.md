...
Program checkpoint: CQ0 is current at correctness inventory digest `5d1fc9d21e511e13bef5ceb476dbcf9dd20ed067339edd2891013992fb06ced5`; PQ0 is dependency-regenerated at performance inventory digest `a7177e298b5e1f05979b871704514fdf2650070a7c48e5d72c6fb48bb80d13bf`. The CQ1 clean PR, full, and soak runs from revision `e7ba513822c26859a2b5c70c94d406e1c6adb6b6` and the PQ1 schema-version-13 runs from revision `bfef511ccaa57c61cbe209c41d89d77ba8f52eee` remain historical harness-acceptance evidence, but their older inventory digests are not promotable evidence for the current case graph.
The active milestone is CQ2: qualify deterministic models, formats, gates, bit kernels, and stabilizer algebra at exact case and exported-API granularity before PQ2 times those surfaces. Its first `.stim`-format slice maps 41 exact source owners onto 19 independently selectable qualification parents; after that source change is committed, rerun clean CQ1 PR, full, and soak evidence and then clean PQ1 PR, full, and soak evidence before promoting dependent product performance work.
