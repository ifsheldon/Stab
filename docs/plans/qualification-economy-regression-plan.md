...
The active execution contract is now [the Stim core parity and lean evidence plan](stim-core-parity-and-lean-evidence-plan.md) and [GOAL.md](GOAL.md). This document remains the normative historical record for the completed Q0 through Q8 qualification program and its evidence, but it does not define current work.
