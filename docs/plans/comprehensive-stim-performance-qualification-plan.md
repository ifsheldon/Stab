...
Evidence: [pq0-performance-disposition-progress-report.md](pq0-performance-disposition-progress-report.md), the completed PQ2 slice reports, and `benchmarks/stim-qualification-suite.json` at current performance digest `e79edf2e1eaa49a801606245d4a845d47a1d000ed527c9669d95e091c4480237`, bound to correctness digest `a739d350eeb3455d4a0b386f8a257d3d4fe01d417d7d11d8a269229d68a6a103`. Thirteen exact runtime contracts are implemented with independent exact `1.25x` targets. Clean revision `cd1e33e10f45995ccaca498547ff5aa88bfe51bb` passed and replayed the complete source-current post-migration Pauli evidence chain after strengthening the exact CQ owner. Clean pre-migration revision `3a0fcd814f8d1a9441420ab85edf3d757572ba93` remains historical authorization for migration commit `42c132f2c49538364649cd90962166223c72b4c6`, which retired only the legacy Pauli timing thresholds and scale mappings. The memory baseline remains for PQ6. Earlier completed groups remain historical under their recorded inventories.
...
Status: Active as of 2026-07-17. All 271 selected CQ2 parents have complete exact ownership. Thirteen exact runtime groups are implemented at post-migration performance inventory `e79edf2e1eaa49a801606245d4a845d47a1d000ed527c9669d95e091c4480237`, including exact public in-place Pauli-string multiplication with deterministic non-identity operands. The ninth slice passed its complete source-current Linux AArch64 chain at clean revision `cd1e33e10f45995ccaca498547ff5aa88bfe51bb`, after the historical pre-migration receipt authorized retirement of only the legacy timing mappings and thresholds. Native x86-64, PQ6 memory growth, the complete current-digest 271-parent run, and all later runtime groups remain unclaimed. Earlier groups retain historical passing evidence under their recorded inventories.
