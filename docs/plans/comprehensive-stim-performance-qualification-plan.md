...
Evidence: [pq0-performance-disposition-progress-report.md](pq0-performance-disposition-progress-report.md), the completed PQ2 slice reports, and `benchmarks/stim-qualification-suite.json` at current performance digest `84d5ab682acda2a847972a74c5d58443fde8d2c820e62e46b634562e7c918e46`, bound to correctness digest `3db44922e3310cb3a573fcff3b28d5eea5d28e0d6975e0856965c601ecc23c72`. Thirteen exact runtime contracts are implemented with independent exact `1.25x` targets, including allocating and in-place BitMatrix transpose plus non-identity Pauli right multiplication. Clean reviewed revision `f912cc3af1f13cc9fab798d69937c155d37d83a0` remains accepted historical transpose evidence under its exact preceding inventories; the current Pauli contract has no accepted timing outcome yet. Completed evidence retired the duplicate legacy M12 `not_zero` and sparse-XOR timing pairs and the heterogeneous transpose timing row while retaining their required memory baselines, the XOR timing pair, the `m5-simd-word` guard, and every legacy Pauli timing threshold until exact replacement completion evidence exists. The legacy canonical-print diagnostic remains superseded and no longer owns beta, timing-regression, or memory waivers.
...
Status: Active as of 2026-07-17. All 271 selected CQ2 parents have complete exact ownership. Thirteen exact runtime groups are implemented at performance inventory `84d5ab682acda2a847972a74c5d58443fde8d2c820e62e46b634562e7c918e46`, including exact public in-place Pauli-string multiplication with deterministic non-identity operands. Parser, canonical printing, gate-name hashing, SIMD-word popcount, complete-vector XOR, the three independent `not_zero` groups, the independent sparse row-XOR and item-toggle groups, and both transpose groups have historical passing controlled-host evidence under their recorded inventories. The active ninth slice has executable harness and inventory contracts but no accepted performance outcome; native x86-64 and PQ6 memory growth remain unclaimed. Remaining model, format, kernel, and algebra groups are still planned.
...
Source-current ninth-slice inventory note, 2026-07-17: correctness digest `3db44922e3310cb3a573fcff3b28d5eea5d28e0d6975e0856965c601ecc23c72` and performance digest `84d5ab682acda2a847972a74c5d58443fde8d2c820e62e46b634562e7c918e46` add the executable exact Pauli contract, scale-aware legacy mappings, sealed workers, and rejection matrix. This inventory readiness does not promote a Pauli ratio or relabel the accepted eighth-slice evidence as current.
