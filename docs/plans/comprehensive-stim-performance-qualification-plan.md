...
Evidence: [pq0-performance-disposition-progress-report.md](pq0-performance-disposition-progress-report.md), the completed PQ2 slice reports, and `benchmarks/stim-qualification-suite.json` at current pre-migration performance digest `ad3b6640e04855ac76d4851f856bb405e7c80c55dbcd67b204d67ea41d40c1eb`, bound to correctness digest `4c940e983df10a7c95cc512939f4a0cce79f1865e141739af9378db581ea5f87`. Fifteen exact product runtime contracts are implemented with independent exact `1.25x` targets. The two Pauli iterator contracts have executable source contracts but no promotable current-digest timing evidence yet, and the bundled iterator timing threshold remains active. Clean revision `cd1e33e10f45995ccaca498547ff5aa88bfe51bb` remains historical accepted Pauli multiplication evidence. Clean pre-migration revision `3a0fcd814f8d1a9441420ab85edf3d757572ba93` remains historical authorization for migration commit `42c132f2c49538364649cd90962166223c72b4c6`, which retired only the legacy Pauli multiplication timing thresholds and scale mappings. The memory baseline remains for PQ6. Earlier completed groups remain historical under their recorded inventories.
...
Status: Active as of 2026-07-17. All 271 selected CQ2 parents have complete exact ownership. Fifteen exact product runtime groups are implemented at pre-migration performance inventory `ad3b6640e04855ac76d4851f856bb405e7c80c55dbcd67b204d67ea41d40c1eb`, including exact public in-place Pauli-string multiplication and the two split Pauli-string iterator workload shapes. The ninth slice remains accepted historical Linux AArch64 evidence at clean revision `cd1e33e10f45995ccaca498547ff5aa88bfe51bb`. The tenth slice has source and contract implementation but no current-digest promotable timing evidence yet, so its legacy timing guard remains active. Native x86-64, PQ6 memory growth, the complete current-digest 271-parent run, and all later runtime groups remain unclaimed. Earlier groups retain historical passing evidence under their recorded inventories.
...
Source-current implementation checkpoint, 2026-07-17: correctness inventory `4c940e983df10a7c95cc512939f4a0cce79f1865e141739af9378db581ea5f87` and pre-migration performance inventory `ad3b6640e04855ac76d4851f856bb405e7c80c55dbcd67b204d67ea41d40c1eb` contain both executable iterator contracts and their exact three-case prerequisites. Core revision `8503f458eac09fe94dba54cf8d6e16e88e195df4` provides the independent CQ owner and active-term iterator optimization. The private Stab build receipt is schema version 3, the adapter receipt and contract preflight are schema version 10 with 140 exact accepted and rejected receipts, and qualification reports are schema version 28. Both source-owned adapter probes execute their accepted maximum and all six rejection classes against both implementations in addition to the default exact comparison. No clean correctness report, worker-reproducibility receipt, product timing report, regression, rollup, completion receipt, migration authorization, audit closure, or review closure is claimed by this checkpoint; the bundled `m6-pauli-iter` timing threshold and both mappings remain active.
