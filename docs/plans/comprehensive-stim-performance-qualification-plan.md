...
The fourth runtime contract remains under acceptance correction at performance inventory `877df12bf1b3d63da92289e22f117097cedbc20860d165c90b41554aa110263b`. Initial full-tier reports from clean revision `38a2d5eab2fec3211eb9466899c6afd0ba91c4ca` under superseded performance inventory `9be7dea23a221e9d7fe6ba2e9bdfaf65ad2b4a7675b557386b3de6ea58306557` are diagnostic history only because milestone audit found that the Stim worker called the broader `simd_bits::popcnt()` helper, the output identity omitted three fixture-fingerprint lanes, and final-state work remained inside timing. A later clean probe at revision `238cf3429e25aa6ed63dce716ed3c14f9ed5f5b3` proved private-worker reproducibility and produced one passing small full-tier report, but GPT-5.6/max review correctly rejected promotion because the preflight digest did not include the six worker identities and therefore could be transplanted between worker pairs. The corrected source now binds the exact comparator implementation through two source digests, owns the frozen protocol vector in one shared contract, binds every worker preparation through 18 actual probe receipts plus both workers' six identities, and rejects refingerprinted transplants during report replay. It still requires a clean commit and the complete CQ, reproducibility, probe, full, soak, regression, rollup, audit, and review chain before any popcount ratio is current evidence. The earlier gate-name-hash timing reports remain valid historical evidence under performance inventory `1cc0be5c8c0a37c98bd4fb56f331dd6964e6f53e56b328b9564be507cbf88a42`; they are not relabeled as current after the shared workers and global performance inventory changed.
