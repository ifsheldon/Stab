...
Status: Active as of 2026-07-16. All 271 selected CQ2 parents have complete exact ownership. Twelve exact runtime groups are implemented at performance inventory `3d8da16998e4ea387f025a55e61b1c8c0ce8a3202804633aae4083dc4647d2cb`, including independent allocating and in-place BitMatrix transpose groups. Parser, canonical printing, gate-name hashing, SIMD-word popcount, complete-vector XOR, the three independent `not_zero` groups, and the independent sparse row-XOR and item-toggle groups have historical passing controlled-host evidence under their recorded inventories. The transpose groups have complete passing first-stage evidence at clean revision `e660c91cff142b611f52a0a28a36e0a3d15670ed`; their focused timing migration is source-current, and the complete post-migration evidence, audit, review, and progress report remain pending. Remaining model, format, kernel, and algebra groups are still planned.
