...
Evidence: [pq0-performance-disposition-progress-report.md](pq0-performance-disposition-progress-report.md), the PQ2 slice reports, `benchmarks/stim-qualification-suite.json` at current schema-version-2 performance digest `30e9df3e8004b59e43716dbb9e7aa847f472811e0adba74c43ef6bc7b243d498`, and the checked schema-version-2 `benchmarks/qualification-threshold-migrations.json` authorization ledger, all bound to correctness digest `17d736fcbeed5b98e6ef04c1d5dee75dfde833259cd345bf40efd44ed2961942`. Nineteen exact product runtime contracts are implemented with one exact `1.25x` measurement rule over each three-scale family, for 57 scale outcomes. Clean revision `9497df0350cb33dcd249ea12fda802b5a68efe00` retains a complete historical DEM chain whose worst confidence-interval upper bound is `1.150114x`, but independent review rejected it as current evidence after finding missing pinned-Stim DEM edge contracts, asymmetric C++ post-return assignment timing, and mismatched peak-RSS phase boundaries. Clean repaired-source revision `80fb5405fb077c694a8a8a18e64a3a5831e20a5e` supplies the fresh focused CQ prerequisite, worker and probe reproduction, twelve reports and regressions, four rollups, two completions, and accepted-maximum memory observations. Every timing gate passed on its first attempt with worst confidence-interval upper bound `1.073689x`; final twelfth-slice acceptance remains pending repeated milestone audit and independent review. Earlier Clifford, iterator, Pauli, transpose, kernel, and circuit evidence remains accepted only under its recorded inventory and is not relabeled under the current shared-adapter digest.
...
Status: Active as of 2026-07-23. All 271 selected CQ2 parents have complete exact ownership. The source-current correctness inventory is `17d736fcbeed5b98e6ef04c1d5dee75dfde833259cd345bf40efd44ed2961942`, and the source-current post-migration performance inventory is `30e9df3e8004b59e43716dbb9e7aa847f472811e0adba74c43ef6bc7b243d498`. Nineteen exact product runtime groups are implemented; the twelfth slice owns independent direct DEM parse and canonical-print groups with fixed scales, exact input and output identities, common-iteration timing, accepted-maximum and hostile-boundary contracts, strict `1.25x` rules, and a source-owned profiler note. Clean repaired-source revision `80fb5405fb077c694a8a8a18e64a3a5831e20a5e` completed the exact focused correctness prerequisite and the full DEM probe, reproducibility, full, soak, regression, rollup, completion, and accepted-maximum memory sequence without rerunning or overwriting a retained timing result. Revision `9497df0350cb33dcd249ea12fda802b5a68efe00` and every earlier DEM result remain historical under their exact inventories. The twelfth slice remains pending only repeated milestone audit, five new independent review lanes, resolution of confirmed findings, final verification, and synchronized acceptance docs. Native x86-64, PQ6 memory growth, and all later runtime groups remain unclaimed.
