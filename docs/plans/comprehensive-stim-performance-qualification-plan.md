...
Status: Active as of 2026-07-16. All 271 selected CQ2 parents have complete exact ownership. Twelve exact runtime groups are implemented at performance inventory `1ff62c5aaebb8d47b1956d135fd5889d376ca2b397226ccdcaa142bcdfa60fb3`, including independent allocating and in-place BitMatrix transpose groups. Parser, canonical printing, gate-name hashing, SIMD-word popcount, complete-vector XOR, the three independent `not_zero` groups, and the independent sparse row-XOR and item-toggle groups have historical passing controlled-host evidence under their recorded inventories. The transpose groups are awaiting clean correctness, reproducibility, probe, timing, regression, rollup, completion, audit, review, and migration evidence. Remaining model, format, kernel, and algebra groups are still planned.
