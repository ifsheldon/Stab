...
Status: Active as of 2026-07-16. All 271 selected CQ2 parents have complete exact ownership. Twelve exact runtime groups are implemented at performance inventory `1d38c155acbaf78234f9b92857cfef8c25ffa059a4a9e9756b272a72272dfd0d`, including independent allocating and in-place BitMatrix transpose groups. Parser, canonical printing, gate-name hashing, SIMD-word popcount, complete-vector XOR, the three independent `not_zero` groups, and the independent sparse row-XOR and item-toggle groups have historical passing controlled-host evidence under their recorded inventories. The reviewed allocating and in-place transpose groups have complete passing source-current Linux AArch64 evidence at clean revision `f912cc3af1f13cc9fab798d69937c155d37d83a0`; native x86-64 and PQ6 memory growth remain unclaimed. Remaining model, format, kernel, and algebra groups are still planned.
