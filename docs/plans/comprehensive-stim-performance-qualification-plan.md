...
Status: Active as of 2026-07-16. All 271 selected CQ2 parents have complete exact ownership. Ten exact runtime groups remain implemented, and two exact BitMatrix transpose API groups are planned at performance inventory `43798bc7a9c81e371e5c3e37ca6d7809ad087ae438b70bee6e8562e9331a6448`. Parser, canonical printing, gate-name hashing, SIMD-word popcount, complete-vector XOR, the three independent `not_zero` groups, and the independent sparse row-XOR and item-toggle groups have historical passing controlled-host evidence under their recorded inventories. The transpose groups and remaining model, format, kernel, and algebra groups are still planned.
