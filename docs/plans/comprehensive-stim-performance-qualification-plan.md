...
Status: Active as of 2026-07-23. All 271 selected CQ2 parents have complete exact ownership. The source-current correctness inventory is `9b110280da2ac9c61568265a19c6b41ead79aa1bec6c8943ecee6a5b6d39df5`, and the source-current post-migration performance inventory is `30e9df3e8004b59e43716dbb9e7aa847f472811e0adba74c43ef6bc7b243d498`. Nineteen exact product runtime groups are implemented; the twelfth slice owns independent direct DEM parse and canonical-print groups with fixed scales, exact input and output identities, common-iteration timing, accepted-maximum and hostile-boundary contracts, strict `1.25x` rules, and a source-owned profiler note. Independent review is complete and its confirmed correctness, timing, RSS, and documentation findings are repaired in source, but no repaired-source machine chain exists yet. Revision `9497df0350cb33dcd249ea12fda802b5a68efe00` and every earlier DEM result remain historical under their exact inventories. The next clean revision must regenerate the exact focused correctness prerequisite and the complete DEM probe, reproducibility, full, soak, regression, rollup, completion, accepted-maximum memory, audit, and review sequence without rerunning or overwriting a retained artifact. Native x86-64, PQ6 memory growth, and all later runtime groups remain unclaimed.
