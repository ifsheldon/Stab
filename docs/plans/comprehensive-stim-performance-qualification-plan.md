...
Evidence: [pq0-performance-disposition-progress-report.md](pq0-performance-disposition-progress-report.md), [pq2-circuit-parse-qualification-progress-report.md](pq2-circuit-parse-qualification-progress-report.md), [pq2-circuit-canonical-print-qualification-progress-report.md](pq2-circuit-canonical-print-qualification-progress-report.md), [pq2-gate-name-hash-qualification-progress-report.md](pq2-gate-name-hash-qualification-progress-report.md), [pq2-simd-word-popcount-qualification-progress-report.md](pq2-simd-word-popcount-qualification-progress-report.md), [pq2-simd-bits-xor-qualification-progress-report.md](pq2-simd-bits-xor-qualification-progress-report.md), and `benchmarks/stim-qualification-suite.json` at current performance digest `fb50789c58786219c807c79e87202396b17563ee7cb584bcda4d3379007ed716`, bound to correctness digest `ccb80eb4b660a375b59460c3b7fa03a810abd6f868735b566735378105db22b2`. `PERFQ-M4-CIRCUIT-PARSE`, `PERFQ-M4-CIRCUIT-CANONICAL-PRINT`, `PERFQ-M4-GATE-LOOKUP`, `PERFQ-M5-SIMD-WORD`, and `PERFQ-M5-SIMD-BITS` are implemented exact runtime contracts with exact `1.25x` targets. Clean revisions `ba70a52025fdd4122ac97cec263725b2ec56e431`, `c76b7071fc4d7ac358ef3a2fffc053ea675bd05f`, and `56dfe7569c6da48ffe76bde18f21ff43095f029b` produced passing AArch64 evidence for the first four groups under preceding inventories; those reports remain historical after later groups changed the global inventory and shared workers. Clean revision `5d226c94ece70f96d0b771f9c8cde7464ccd261b` supplies current passing full and soak AArch64 dense-XOR evidence at all three scales, with median ratios from `0.374633x` to `0.559828x` and worst confidence-interval upper bound `0.561257x`. The legacy canonical-print diagnostic is superseded and no longer owns beta, timing-regression, or memory waivers. The legacy `m5-simd-word` threshold and both legacy `m5-simd-bits` XOR and `not_zero` submeasurement thresholds remain active until explicit replacement migration.
...
Status: Active as of 2026-07-16. All 271 selected CQ2 parents have complete exact ownership. Five exact runtime groups are implemented at performance inventory `fb50789c58786219c807c79e87202396b17563ee7cb584bcda4d3379007ed716`. Parser, canonical printing, gate-name hashing, and SIMD-word popcount have historical passing controlled-host evidence under preceding inventories. `PERFQ-M5-SIMD-BITS` has current clean passing full and soak AArch64 dense-XOR evidence plus replayed scale-family rollups from revision `5d226c94ece70f96d0b771f9c8cde7464ccd261b`. The remaining model, format, kernel, and algebra groups are still planned.
