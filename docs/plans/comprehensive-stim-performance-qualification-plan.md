...
Evidence: [pq0-performance-disposition-progress-report.md](pq0-performance-disposition-progress-report.md), the completed PQ2 slice reports, and `benchmarks/stim-qualification-suite.json` at current post-migration performance digest `48eacf03a2ecdca917c05aade52b7e17c9ead1be8b75b203e1d43c2f3b3b7dbf`, bound to correctness digest `4c940e983df10a7c95cc512939f4a0cce79f1865e141739af9378db581ea5f87`. Fifteen exact product runtime contracts are implemented with independent exact `1.25x` targets. Clean revision `f2388dccc01abb7ef89e5f56d9062c6656837470` completed and replayed both iterator groups under pre-migration digest `ad3b6640e04855ac76d4851f856bb405e7c80c55dbcd67b204d67ea41d40c1eb`, authorizing retirement of only the bundled iterator timing threshold and its two mappings. The post-migration iterator chain remains pending, and the memory baseline remains guarded for PQ6. Clean revision `cd1e33e10f45995ccaca498547ff5aa88bfe51bb` remains historical accepted Pauli multiplication evidence. Earlier completed groups remain historical under their recorded inventories.
...
Status: Active as of 2026-07-17. All 271 selected CQ2 parents have complete exact ownership. Fifteen exact product runtime groups are implemented at post-migration performance inventory `48eacf03a2ecdca917c05aade52b7e17c9ead1be8b75b203e1d43c2f3b3b7dbf`, including exact public in-place Pauli-string multiplication and the two split Pauli-string iterator workload shapes. The ninth slice remains accepted historical Linux AArch64 evidence at clean revision `cd1e33e10f45995ccaca498547ff5aa88bfe51bb`. Clean revision `f2388dccc01abb7ef89e5f56d9062c6656837470` supplied complete pre-migration iterator evidence and authorized the narrow legacy timing migration; the complete post-migration chain remains pending. Native x86-64, PQ6 memory growth, the complete current-digest 271-parent run, and all later runtime groups remain unclaimed. Earlier groups retain historical passing evidence under their recorded inventories.
...
Source-current migration checkpoint, 2026-07-17: correctness inventory `4c940e983df10a7c95cc512939f4a0cce79f1865e141739af9378db581ea5f87` and post-migration performance inventory `48eacf03a2ecdca917c05aade52b7e17c9ead1be8b75b203e1d43c2f3b3b7dbf` contain both executable iterator contracts and their exact three-case prerequisites. Core revision `8503f458eac09fe94dba54cf8d6e16e88e195df4` provides the independent CQ owner and active-term iterator optimization. Clean pre-migration revision `f2388dccc01abb7ef89e5f56d9062c6656837470` passed and replayed exact correctness, reproducible workers, both complete adapter probes, 12 first-attempt reports and regressions, four rollups, and two completion receipts under performance inventory `ad3b6640e04855ac76d4851f856bb405e7c80c55dbcd67b204d67ea41d40c1eb`, authorizing retirement of only the bundled iterator timing threshold and both mappings. The private Stab build receipt remains schema version 3, the adapter receipt and contract preflight remain schema version 10 with 140 exact accepted and rejected receipts, and qualification reports remain schema version 28. The inherited iterator row is now superseded and its memory baseline remains explicitly guarded for PQ6. No post-migration timing report, regression, rollup, completion receipt, audit closure, review closure, or final progress report is claimed by this checkpoint.
