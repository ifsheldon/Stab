...
Status: Active as of 2026-07-18. All 271 selected CQ2 parents have complete exact ownership, and clean correctness revision `3f2f382627c8421de0a668819d467a9f252de20f` provides source-current PR, full, and soak execution plus report replay and exact preflight for its recorded hardened-controller revision. Performance consumer commits `9be47ff2`, `0a9b228d`, and `7d0c07eb` reconstruct coherent historical 6/3 and current 7/4 artifact families, reject mixed schemas and producer-impossible passing receipts, and globally reconcile statistical ownership, seeds, shots, attempts, and per-case receipts. A clean verified-host probe at `7d0c07eb` consumed a same-revision focused CQ prerequisite in the real gate-lookup product runner and replayed its schema-version-28 report. Every new promotable product run must still consume focused exact CQ evidence produced from the same clean revision as its workers. Fifteen exact product runtime groups are implemented at performance inventory `868eb831a034042b43573fed612af14db225421a2733bbf10e4a5eb2b515ec90`, including exact public in-place Pauli-string multiplication and the two split Pauli-string iterator workload shapes. The synchronized CQ2 checklist-status refresh changes no executable contract or threshold, but it ages every report under preceding inventory `48eacf03a2ecdca917c05aade52b7e17c9ead1be8b75b203e1d43c2f3b3b7dbf`. The ninth and tenth slices therefore remain accepted historical Linux AArch64 evidence at their recorded revisions and inventories. Native x86-64, PQ6 memory growth, current-inventory timing evidence, and all later runtime groups remain unclaimed.
