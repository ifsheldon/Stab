...
Evidence: [pq0-performance-disposition-progress-report.md](pq0-performance-disposition-progress-report.md), the completed PQ2 slice reports, and `benchmarks/stim-qualification-suite.json` at current performance digest `adb7f822ff892b3d85b362130f048d7fe76f6e314349e5f42e71f54389a771d7`, bound to correctness digest `4c940e983df10a7c95cc512939f4a0cce79f1865e141739af9378db581ea5f87`. Seventeen exact product runtime contracts are implemented with one exact `1.25x` measurement rule over each three-scale family, for 51 scale outcomes. The current digest adds separate identity and non-identity Clifford-string contracts and does not inherit timing evidence from any earlier inventory. Clean reviewed iterator evidence revision `afaf0bf7f236b9f6ae6f72c19bbbdfea94d26632` remains accepted historical AArch64 evidence with 12 first-attempt passing reports and regressions, four replayed rollups, and two replayed completion receipts after exact accepted-maximum strengthening and clean final review. The memory baseline remains guarded for PQ6. Earlier completed groups remain historical under their recorded inventories.
...
Status: Active as of 2026-07-18. All 271 selected CQ2 parents have complete exact ownership, and clean correctness revision `3f2f382627c8421de0a668819d467a9f252de20f` provides source-current PR, full, and soak execution plus report replay and exact preflight for its recorded hardened-controller revision. Performance consumer commits `9be47ff2`, `0a9b228d`, and `7d0c07eb` reconstruct coherent historical 6/3 and current 7/4 artifact families, reject mixed schemas and producer-impossible passing receipts, and globally reconcile statistical ownership, seeds, shots, attempts, and per-case receipts. A clean verified-host probe at `7d0c07eb` consumed a same-revision focused CQ prerequisite in the real gate-lookup product runner and replayed its schema-version-28 report. Every new promotable product run must still consume focused exact CQ evidence produced from the same clean revision as its workers. Seventeen exact product runtime groups are implemented at performance inventory `adb7f822ff892b3d85b362130f048d7fe76f6e314349e5f42e71f54389a771d7`, including exact public in-place Pauli-string multiplication, the two split Pauli-string iterator workload shapes, and separate identity and complete non-identity Clifford-string multiplication. This inventory change ages every earlier timing report and carries no Clifford timing claim. The ninth and tenth slices remain accepted historical Linux AArch64 evidence at their recorded revisions and inventories. Native x86-64, PQ6 memory growth, current-inventory timing evidence, and all later runtime groups remain unclaimed.
