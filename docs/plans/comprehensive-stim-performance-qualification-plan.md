...
Status: Active as of 2026-07-16. All 271 selected CQ2 parents have complete exact ownership. Eight exact runtime groups are implemented at performance inventory `7fc15258f7fe1e5e4ca075c41e9ab2b869e7d845a11f5f8694386e854cea5435`. Parser, canonical printing, gate-name hashing, SIMD-word popcount, and complete-vector XOR have historical passing controlled-host evidence under preceding inventories. The three independent `not_zero` groups are implementation-complete but still require clean correctness, full, soak, regression, rollup, completion-receipt, audit, and review evidence. The remaining model, format, kernel, and algebra groups are still planned.
...
The source-current performance inventory is `7fc15258f7fe1e5e4ca075c41e9ab2b869e7d845a11f5f8694386e854cea5435`. It contains all three implemented `not_zero` runtime contracts and their independent `1.25x` rules, plus an exact legacy replacement mapping to the early group. This is contract and implementation state, not performance acceptance. No sixth-slice ratio, rollup, or completion receipt is yet promotable, and every first-five timing report remains historical after the global inventory and shared worker identities changed.
