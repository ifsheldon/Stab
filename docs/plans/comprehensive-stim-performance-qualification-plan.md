...
Status: Active as of 2026-07-18. All 271 selected CQ2 parents have complete exact ownership. Fifteen exact product runtime groups are implemented at post-migration performance inventory `48eacf03a2ecdca917c05aade52b7e17c9ead1be8b75b203e1d43c2f3b3b7dbf`, including exact public in-place Pauli-string multiplication and the two split Pauli-string iterator workload shapes. The ninth slice remains accepted historical Linux AArch64 evidence at clean revision `cd1e33e10f45995ccaca498547ff5aa88bfe51bb`. Clean evidence revision `afaf0bf7f236b9f6ae6f72c19bbbdfea94d26632` closes the tenth split iterator machine evidence under the source-current correctness and performance inventories after the pre-migration authorization, narrow legacy timing migration, and accepted-maximum exact-owner strengthening. Native x86-64, PQ6 memory growth, the complete current-digest 271-parent run, and all later runtime groups remain unclaimed. Earlier groups retain historical passing evidence under their recorded inventories.
...
Accepted tenth-slice checkpoint, 2026-07-18: correctness inventory `4c940e983df10a7c95cc512939f4a0cce79f1865e141739af9378db581ea5f87` and post-migration performance inventory `48eacf03a2ecdca917c05aade52b7e17c9ead1be8b75b203e1d43c2f3b3b7dbf` contain both executable iterator contracts and their exact three-case prerequisites. Core revision `8503f458eac09fe94dba54cf8d6e16e88e195df4` provides the active-term iterator optimization, clean pre-migration revision `f2388dccc01abb7ef89e5f56d9062c6656837470` authorized retirement of only the bundled iterator timing threshold and both mappings, and migration commit `d706634eeaa536b2ce48d3dc9431b4feb513317f` made that focused change while preserving the memory baseline. Clean reviewed evidence revision `afaf0bf7f236b9f6ae6f72c19bbbdfea94d26632` publishes the source-current exact correctness prerequisite with complete accepted-maximum traversal, reproducible workers, both complete adapter probes, 12 first-attempt passing reports and regressions, four rollups, and two completion receipts. Median ratios range from `0.025664x` to `0.568566x`, with worst confidence-interval upper bound `0.570628x`. The private Stab build receipt remains schema version 3, the adapter receipt and contract preflight remain schema version 10 with 140 exact accepted and rejected receipts, and qualification reports remain schema version 28. Milestone audit found and resolved the accepted-maximum specification loophole with no remaining implementation finding. Two final GPT-5.6/max review lanes found and closed operational-documentation and provisional-status inconsistencies, then reported no remaining P0 through P3 finding. Exact closure artifacts are recorded in `docs/plans/pq2-pauli-string-iterator-qualification-progress-report.md`. The inherited iterator row remains superseded and its memory baseline remains explicitly guarded for PQ6.
