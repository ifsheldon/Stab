...
- PFM4 folded DEM traversal: true folded graphlike, hypergraph, SAT/WCNF, analyzer, matcher-adjacent, or sampled-error traversal work, while preserving Stim-compatible unweighted shortest-error semantics and existing dense target caps.
