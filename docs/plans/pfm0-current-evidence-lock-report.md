...
The selected flat zero-shift SAT repeat folding work preserves this boundary by folding unweighted repeated bodies structurally, including zero-probability mechanisms, where one body copy represents the same minimum structural parity cost without probability-based skipping.
