...
- True folded graphlike, hypergraph, SAT, analyzer, ErrorMatcher, and sampler traversal remains open if Stab chooses to avoid expansion even within the current cap.
