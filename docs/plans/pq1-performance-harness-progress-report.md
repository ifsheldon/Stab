...
> Current-evidence note, 2026-07-17: correctness inventory digest `3db44922e3310cb3a573fcff3b28d5eea5d28e0d6975e0856965c601ecc23c72` and performance inventory digest `84d5ab682acda2a847972a74c5d58443fde8d2c820e62e46b634562e7c918e46` are source-current after graduating the exact non-identity Pauli contract. The product harness has thirteen executable exact-case groups, adapter receipt schema version 9, contract-preflight schema version 9 with 104 probes, and qualification report schema version 27. The Pauli group has inventory and execution readiness only, with no accepted ratio or completion evidence. Clean revision `f912cc3af1f13cc9fab798d69937c155d37d83a0` remains accepted historical transpose evidence under its recorded inventories, while the earlier `not_zero`, sparse-XOR, and dense-XOR evidence remains historical under its own recorded identities. The schema-version-13 PQ1 reports remain historical diagnostic infrastructure evidence, not product performance.
