...
> Current-evidence note, 2026-07-14: the completed selected CQ2 `.stim` and `.dem` slices change the correctness inventory digest to `cd82f99bd3f02446187b55c873e396e08c234f86693ba5f5734882fbe4814b56`, and source-owned checklist synchronization changes the dependent performance inventory digest to `2cd3f0cd44f2450297dc87abec98156eb717127483a051f8dd48ee29bdc39fcd`. The last clean schema-version-13 PR, full, and soak reports from revision `f62cdf135f6804419809e74d9e68c66551adf6e3` predate that checklist-only digest change; their diagnostic ratios were 1.015708, 1.015081, and 1.015031 respectively. A clean current-digest refresh is required before promotion. See `docs/plans/cq2-deterministic-qualification-progress-report.md`. The reports remain diagnostic infrastructure evidence, not product performance.
