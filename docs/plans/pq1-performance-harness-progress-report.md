...
> Current-evidence note, 2026-07-19: correctness inventory digest `4dbbb4b2cda3117bdd3d3ddfcd30b55f09e6f401352e3e86130222189d47791f` and performance inventory digest `18f2b401f386ec3fb459a2d26497a96b881f03d70ca9089665323b1efb61eff4` are source-current. The product harness has seventeen executable exact-case groups plus its diagnostic protocol group, private Stab build-receipt schema version 4, adapter receipt schema version 11, contract-preflight schema version 11 with 202 probes, and qualification report schema version 29. The current digest binds both Clifford-string groups to the profiler note for scalar failure, packed portable-SIMD optimization, scalable independent oracles, and the exact legacy identity/small replacement; it carries no promoted Clifford timing evidence. Clean iterator and earlier product evidence remains accepted historical evidence under each recorded inventory. The schema-version-13 PQ1 reports remain historical diagnostic infrastructure evidence, not product performance.
