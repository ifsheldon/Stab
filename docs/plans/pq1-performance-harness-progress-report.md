...
> Current-evidence note, 2026-07-15: canonical-printer parity and resource ownership set correctness inventory digest `b80801fea6eae550feecf40489259de56123f6f3331b747d52c323d576fd0285`, and retirement of the superseded legacy printer waiver sets performance inventory digest `f3c4009044b0bafcd877f76798c7f4f08c475c0877b85f68d22ae0449e3ddb8f`. Current-digest exact correctness and AArch64 performance evidence exists for circuit parsing and canonical printing; the earlier all-domain CQ2 reports still require a refreshed run before they can be cited as source-current. The schema-version-13 PQ1 PR, full, and soak reports from revision `d0ecafd62794daad0ab5eb63d54c481a5e32a30b` bind older inventory and runtime protocol contracts and remain historical; their diagnostic median ratios 1.014015, 1.015160, and 1.015225 are report-only infrastructure evidence, not product performance. See `docs/plans/cq2-deterministic-qualification-progress-report.md` and the active PQ2 section of `docs/plans/comprehensive-stim-performance-qualification-plan.md`.
