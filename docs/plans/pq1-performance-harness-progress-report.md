...
> Current-evidence note, 2026-07-14: the completed selected CQ2 `.stim`, `.dem`, result-format, and gate-contract slices change the correctness inventory digest to `4ee9686104c0d537073a823986cb71b8bc092c7a9f09fbdbee75c4af7d2c6b70` and the dependent performance inventory digest to `9ae9b79c172c27f2a33475d856cca97c668c6608781cb81b8a8861f46cd13966`. Clean current-digest schema-version-13 PR, full, and soak reports from revision `c6ca93945ad7e94e758e2cdea745a9b2a62c401a` are host-verified and pass offline validation; their diagnostic ratios are 1.015311, 1.014834, and 1.015483 respectively. Report-only regression replay returns `checked=0 report_only=true` for every tier. See `docs/plans/cq2-deterministic-qualification-progress-report.md`; these ratios remain diagnostic infrastructure evidence, not product performance.
