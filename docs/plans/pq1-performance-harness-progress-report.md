...
> Current-evidence note, 2026-07-15: reviewed negative-zero analyzer ownership sets correctness inventory digest `4d9faa21e318eeebc4614c7bf62491bb2db73b5db57ae3dab7d0f19f3fda7cad`, and the first two PQ2 product-contract graduations set performance inventory digest `b6bf408c54461d65670200fe701f7fff3e5e0470509d8fc89aeab729a242781b`. Current-digest exact correctness owners exist for circuit parsing and canonical printing; the earlier all-domain CQ2 reports require a refreshed run before they can be cited as source-current. The schema-version-13 PQ1 PR, full, and soak reports from revision `d0ecafd62794daad0ab5eb63d54c481a5e32a30b` bind older inventory and runtime protocol contracts and remain historical; their diagnostic median ratios 1.014015, 1.015160, and 1.015225 are report-only infrastructure evidence, not product performance. See `docs/plans/cq2-deterministic-qualification-progress-report.md` and the active PQ2 section of `docs/plans/comprehensive-stim-performance-qualification-plan.md`.
