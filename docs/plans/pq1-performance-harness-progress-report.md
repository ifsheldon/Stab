...
> Current-evidence note, 2026-07-18: correctness inventory digest `c50f27fd097ac870c987d1f91c44d9e6a75510ed4d51ec44853dbc328f0b1fa7` and performance inventory digest `f60aab6b68859a1aeb5a12e90122459ba70a404d94f3d95d7ad0c47b114286b0` are source-current. The product harness has seventeen executable exact-case groups plus its diagnostic protocol group, private Stab build-receipt schema version 4, adapter receipt schema version 11, contract-preflight schema version 11 with 202 probes, and qualification report schema version 29. The current digest binds both Clifford-string groups to the profiler note for scalar failure and packed portable-SIMD optimization; it carries no promoted Clifford timing evidence. Clean iterator and earlier product evidence remains accepted historical evidence under each recorded inventory. The schema-version-13 PQ1 reports remain historical diagnostic infrastructure evidence, not product performance.
