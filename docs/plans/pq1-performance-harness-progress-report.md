...
> Current-evidence note, 2026-07-14: the completed selected CQ2 `.stim` slice changes the correctness inventory digest to `1152e9fa36d55c8a5a2282638fbc8ad79a39e7b4456161fba868a15c45cfb16e`, and the corrected source-owned checklist changes the dependent performance inventory digest to `3b762ed4bcd44157fb5c7410912a30fb6fc7abb4ff69ab95a38ef9892c72bec6`. Clean current-digest schema-version-13 PR, full, and soak reports from revision `7420a6909dd998b721cd15075361f31e431e4180` are host-verified and pass offline validation; their diagnostic ratios are 1.015929, 1.015046, and 1.014783 respectively. See `docs/plans/cq2-deterministic-qualification-progress-report.md`. They remain diagnostic infrastructure evidence, not product performance.
