...
> Current-evidence note, 2026-07-18: correctness inventory digest `4c940e983df10a7c95cc512939f4a0cce79f1865e141739af9378db581ea5f87` and post-migration performance inventory digest `48eacf03a2ecdca917c05aade52b7e17c9ead1be8b75b203e1d43c2f3b3b7dbf` are source-current. The product harness has fifteen executable exact-case groups plus its diagnostic protocol group, private Stab build-receipt schema version 3, adapter receipt schema version 10, contract-preflight schema version 10 with 140 probes, and qualification report schema version 28. Clean revision `f2388dccc01abb7ef89e5f56d9062c6656837470` completed and replayed both Pauli iterator groups under the preceding pre-migration inventory and authorized the narrow legacy timing migration. Clean evidence revision `afaf0bf7f236b9f6ae6f72c19bbbdfea94d26632` closes both source-current post-migration machine chains with 12 first-attempt passing reports and regressions, four replayed rollups, and two replayed completion receipts after complete accepted-maximum traversal strengthening. Clean revision `cd1e33e10f45995ccaca498547ff5aa88bfe51bb` remains historical accepted Pauli multiplication evidence, and clean revision `3a0fcd814f8d1a9441420ab85edf3d757572ba93` remains historical pre-migration authorization for focused migration commit `42c132f2c49538364649cd90962166223c72b4c6`. All earlier product evidence remains historical under its own recorded identities. The schema-version-13 PQ1 reports remain historical diagnostic infrastructure evidence, not product performance.
