...
> Current-evidence note, 2026-07-14: the completed selected CQ2 `.stim`, `.dem`, result-format, gate-contract, and bit-kernel slices change the correctness inventory digest to `2b2f0456e568b86a973d4b9077b9688ab9f7748af1bd9cd349e2a2abf217d638` and the dependent performance inventory digest to `4e31a348b0c796ae4c4400369c70019eff8fa991592f201c80e7fee7d8718f7a`. Schema-version-13 PR, full, and soak reports from revision `c6ca93945ad7e94e758e2cdea745a9b2a62c401a` remain clean historical evidence for the preceding gate-refined digest; their diagnostic ratios are 1.015311, 1.014834, and 1.015483, but a committed current-digest refresh is required before they can support the bit checkpoint. See `docs/plans/cq2-deterministic-qualification-progress-report.md`; these ratios remain diagnostic infrastructure evidence, not product performance.
