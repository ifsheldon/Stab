...
> Current-evidence note, 2026-07-14: the completed selected CQ2 `.stim`, `.dem`, result-format, gate-contract, and bit-kernel slices set correctness inventory digest `2b2f0456e568b86a973d4b9077b9688ab9f7748af1bd9cd349e2a2abf217d638` and dependent performance inventory digest `4e31a348b0c796ae4c4400369c70019eff8fa991592f201c80e7fee7d8718f7a`. Clean schema-version-13 PR, full, and soak reports from revision `d4301cc1085680ff650f9e0474e075998c14c4bd` pass with diagnostic ratios 1.016046, 1.014565, and 1.015206, offline validation, and report-only regression replay. See `docs/plans/cq2-deterministic-qualification-progress-report.md`; these ratios remain diagnostic infrastructure evidence, not product performance.
