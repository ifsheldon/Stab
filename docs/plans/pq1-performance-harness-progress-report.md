...
> Current-evidence note, 2026-07-19: correctness inventory digest `4dbbb4b2cda3117bdd3d3ddfcd30b55f09e6f401352e3e86130222189d47791f` and schema-version-2 performance inventory digest `a76090c996ad404c1cb8bfa85066e286c6f40b32754b3750e984375f7ca90025` are source-current. The product harness has seventeen executable exact-case groups plus its diagnostic protocol group, private Stab build-receipt schema version 4, adapter receipt schema version 11, contract-preflight schema version 11 with 202 probes, runtime-group schema version 5, and qualification report schema version 30. The inventory binds both Clifford-string groups to scalable independent oracles, retired legacy identity/small timing provenance, normalized statistics, and source-owned independent-throughput timing only for the identity group; the runtime-group ledger separately binds their profiler note for scalar failure and packed portable-SIMD optimization. Neither contract carries promoted Clifford timing evidence. Clean iterator and earlier product evidence remains accepted historical evidence under each recorded inventory. The schema-version-13 PQ1 reports remain historical diagnostic infrastructure evidence, not product performance.
