...
The focused implementation commit is `abcaffdf`. Clean-revision flow and tracker benchmark evidence follows the qualification and documentation checkpoint; until then, this slice makes no fresh timing claim.
