...
Current RPF6 progress promotes the noisy generated-QEC analyzer semantic subset with explicit oracle row `pf6-analyzer-generated-qec-rust` and report-only benchmark runner `pf6-analyze-errors-generated-surface`; broad generated-loop analyzer behavior, loop-folded decomposition, generated search, and sparse reverse tracker optimization remain governed by the PFM plan.
