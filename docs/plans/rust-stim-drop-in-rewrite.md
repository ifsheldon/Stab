...
PF4 later added selected SAT/WCNF folding for large flat zero-shift DEM repeat bodies: unweighted shortest-error SAT represents each repeated all-nonzero body error once while preserving probability-insensitive structural semantics, and weighted SAT/WCNF folds repeated body errors by concrete MAP parity cost instead of sampling marginal parity probability. Shifted, nested, non-flat, and unweighted zero-probability structural repeat bodies retain explicit caps until separately promoted.
