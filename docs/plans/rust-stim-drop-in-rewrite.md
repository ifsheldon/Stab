...
- Full detector-analysis parity: after the PF plan closes selected non-deferred Rust and CLI subcases, promote any remaining broader detecting-region gauge handling, MPP and observable missing-detector analysis, broader generated-code missing-detector suffix analysis beyond the promoted honeycomb and toric cases, generated surface-code repeat matching, heralded matching, repeat-contained noise stack frames, and full sparse reverse tracker consumption into explicit detector-analysis acceptance rows before claiming full analyzer utility parity.
