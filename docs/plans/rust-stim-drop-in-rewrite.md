...
The remaining post-PF4 sampler work is optimized nested or shifted repeated stochastic nonzero-probability body traversal that can tighten or remove the current sampled-error application work cap without changing flat sampled-error semantics.
