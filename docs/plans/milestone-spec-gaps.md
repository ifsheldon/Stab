...
Resolution: Exact closure scope is selected by PFM-B3 in `docs/plans/non-deferred-partial-feature-milestones.md`. The entry remains open until the shared folded visitor, named consumer migrations, materialization rationales, differential tests, resource tests, benchmark evidence, audit, and review are complete.
