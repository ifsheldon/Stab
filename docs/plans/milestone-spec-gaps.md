...
Resolution: PFM-B4 in `docs/plans/non-deferred-partial-feature-milestones.md` selects evidence closure instead of speculative feature growth. The two named pinned upstream cases and existing promoted target, generated-code, gauge, repeat, and resource evidence now have focused executable evidence. The entry remains open only until milestone audit, GPT-5.6/max review, clean benchmark evidence, and final documentation synchronization complete.
...
Resolution: PFM-B4 in `docs/plans/non-deferred-partial-feature-milestones.md` selects evidence closure instead of an unbounded generated-code or stabilizer-rank matrix. The three named pinned upstream cases and existing promoted row-reduction, observable, gate, repeat, and resource evidence now have focused executable evidence. The entry remains open only until milestone audit, GPT-5.6/max review, clean benchmark evidence, and final documentation synchronization complete.
...
Resolution: Exact closure scope is selected by PFM-B4 in `docs/plans/non-deferred-partial-feature-milestones.md`. The named C++ and Python semantic subcases now have stable selectors, generator and sparse-checker dispatch share typed reverse transitions, exhaustive subset solving is removed in favor of generator-table GF(2) elimination, generated and resource tests pass, and oracle plus benchmark metadata is implemented. The entry remains open only until milestone audit, GPT-5.6/max review, clean benchmark evidence, and final documentation synchronization complete.
