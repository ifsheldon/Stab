...
> Source-current note, 2026-07-23: the current correctness inventory digest is `17d736fcbeed5b98e6ef04c1d5dee75dfde833259cd345bf40efd44ed2961942`, with 1,986 public API records. Independent DEM review added twelve owned `DemRepeatCount` API records and strengthened exact coverage for empty arguments, zero repeats, 60-bit textual limits, ASCII modifier boundaries, and standalone target case. The clean all-domain reports below remain accepted historical evidence under preceding digest `4c940e983df10a7c95cc512939f4a0cce79f1865e141739af9378db581ea5f87`; the source-current inventory has no all-domain execution claim. Clean repaired-source revision `80fb5405fb077c694a8a8a18e64a3a5831e20a5e` passed and replayed the focused exact DEM prerequisite from the same clean revision as its workers.
...
Current correctness inventory digest: `17d736fcbeed5b98e6ef04c1d5dee75dfde833259cd345bf40efd44ed2961942`. It preserves all 271 selected implemented parents, expands the public API inventory to 1,986 records, and keeps the strengthened exact DEM model parent `cq-evidence-qualification-0908c21b917526e3`, but has no all-domain execution claim. Clean revision `3f2f382627c8421de0a668819d467a9f252de20f` remains the latest complete all-domain execution under its preceding digest; the focused DEM prerequisite at `80fb5405fb077c694a8a8a18e64a3a5831e20a5e` is source-current only for that exact parent and dependent machine chain.

Current dependent performance inventory digest: `30e9df3e8004b59e43716dbb9e7aa847f472811e0adba74c43ef6bc7b243d498`. It contains nineteen executable PQ2 product contracts, including independent direct DEM parse and canonical-print groups plus the independent identity and non-identity Clifford-string groups. Runtime-group schema version 5 binds the DEM pair to exact parent `cq-evidence-qualification-0908c21b917526e3`, fixed scales, exact fixture and output identities, and separate pinned-Stim comparator sources. The clean Git revision, private Cargo build, sealed Stab binary digest, and worker identity bind the private parser implementation. The shared harness now uses private Stab build-receipt schema version 6, adapter receipt schema version 12, worker-protocol schema version 4, contract-preflight schema version 14 with 228 probes, and qualification report schema version 33. Revision `859bf202bdd4bdfbca07e9b1d647afb1b0542846` completed the accepted Clifford machine chain under preceding performance digest `a47866ba5eab70392dd2754391d3d7d8588567a7cbfc1f81a569be813804ce51`; the current DEM inventory does not relabel that evidence. Clean iterator, Pauli multiplication, transpose, kernel, and earlier Clifford evidence remains historical under its recorded inventories.
