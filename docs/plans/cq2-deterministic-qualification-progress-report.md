...
> Source-current note, 2026-07-18: packed Clifford-string revision `2a0ab88c44eeeaae1714b0976089ecc1809203f3` changes the selected Algebra implementation source and sets correctness inventory digest `c50f27fd097ac870c987d1f91c44d9e6a75510ed4d51ec44853dbc328f0b1fa7`. The clean all-domain reports below remain accepted historical evidence under preceding digest `4c940e983df10a7c95cc512939f4a0cce79f1865e141739af9378db581ea5f87`; they are not current-checkout preflight. The active Clifford performance slice must publish fresh exact focused prerequisites from the same clean revision as its private workers.
...
Current correctness inventory digest: `c50f27fd097ac870c987d1f91c44d9e6a75510ed4d51ec44853dbc328f0b1fa7`. Packed Clifford-string revision `2a0ab88c44eeeaae1714b0976089ecc1809203f3` changes the exact Algebra implementation source while preserving 271 selected implemented parents. Clean revision `3f2f382627c8421de0a668819d467a9f252de20f` remains the latest complete all-domain execution under the preceding digest, and fresh current-digest focused Clifford evidence is pending.

Current dependent performance inventory digest: `f60aab6b68859a1aeb5a12e90122459ba70a404d94f3d95d7ad0c47b114286b0`. It contains seventeen executable PQ2 product contracts, including independent identity and non-identity Clifford-string groups, and binds both new groups to the source-owned optimization profiler note. Clean iterator, Pauli multiplication, transpose, and kernel evidence remains historical under its recorded inventories. No prior ratio or dirty optimization diagnostic is promoted under the refreshed inventory without a clean exact-group rerun.
