...
> Source-current note, 2026-07-23: the current correctness inventory digest is `592934174f3cf248553d3df67078ec00563e48acfd4c5ddf15cef44fd9b49fd0`, with 2,065 public API records and 1,757 evidence parents: 593 implemented, 17 evidence-close, and 1,147 planned. The result-format source repair adds strict shared text grammars, typed DETS APIs, CLI propagation, file-role safety, and a checked pinned-Stim corpus, bringing the result-format domain to 43 implemented parents and the eight selected deterministic domains to 275. The clean all-domain reports below remain historical evidence under preceding digest `4c940e983df10a7c95cc512939f4a0cce79f1865e141739af9378db581ea5f87`; the source-current inventory has no all-domain execution claim. Revision `80fb5405fb077c694a8a8a18e64a3a5831e20a5e` remains historical focused DEM correctness evidence and cannot authorize current `raw-work-v2` timing.
...
Last checked correctness inventory digest: `592934174f3cf248553d3df67078ec00563e48acfd4c5ddf15cef44fd9b49fd0`. It contains 275 selected implemented parents and 2,065 public API records. The 43 source-current result-format parents include the repaired oracle expectations, strict text grammar, typed DETS ownership, CLI propagation, and file-role safety, but that domain remains reopened until fresh PR, full, and soak execution runs from a clean committed revision. Clean revision `3f2f382627c8421de0a668819d467a9f252de20f` remains historical all-domain execution under its preceding digest. The focused DEM prerequisite at `80fb5405fb077c694a8a8a18e64a3a5831e20a5e` remains historical evidence for its exact parent but cannot authorize the review-rejected `raw-work-v1` machine chain.

Current dependent performance inventory digest: `33b796a2eda59429fcccc43a3db8dc715608e5dffabd9cfe1b756c4d40529358`. It contains nineteen executable PQ2 product contracts, including independent direct DEM parse and canonical-print groups plus the independent identity and non-identity Clifford-string groups. Runtime-group schema version 6 binds the explicit `raw-work-v2` timing boundary, the DEM pair's exact correctness parent, fixed scales, exact fixture and output identities, and separate pinned-Stim comparator sources. The source-current shared harness uses private Stab build-receipt schema version 6, adapter receipt schema version 12, worker-protocol schema version 5, contract-preflight schema version 15 with 228 probes, and qualification report schema version 34. No current promotable report exists under those schemas while the source tree is uncommitted. Revision `859bf202bdd4bdfbca07e9b1d647afb1b0542846` completed the accepted Clifford machine chain under preceding performance digest `a47866ba5eab70392dd2754391d3d7d8588567a7cbfc1f81a569be813804ce51`; current schemas do not relabel that evidence. Clean iterator, Pauli multiplication, transpose, kernel, Clifford, and DEM evidence remains historical under its recorded inventories.
...
- Forty exact qualification parents and three independently selected direct oracle-fixture parents produce 43 implemented result-format evidence parents and zero planned owners.
