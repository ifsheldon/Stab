...
Current correctness inventory digest: `4dbbb4b2cda3117bdd3d3ddfcd30b55f09e6f401352e3e86130222189d47791f`. Packed Clifford review-fix revision `9c672ef3c12c3fe68632e8609a58ae98714bc144` changes the exact Algebra implementation source while preserving 271 selected implemented parents. Clean revision `3f2f382627c8421de0a668819d467a9f252de20f` remains the latest complete all-domain execution under its preceding digest, focused revision `ac20ffca` passed the three Clifford prerequisites under the next preceding digest, and clean pre-migration revision `127d6661a9e00872fc4aa4c0b0d27171e005afa5` passed and replayed the three source-current Clifford prerequisites. The performance controller still requires a fresh focused CQ report from the same clean post-migration revision as its workers before current-inventory timing.

Current dependent performance inventory digest: `a76090c996ad404c1cb8bfa85066e286c6f40b32754b3750e984375f7ca90025`. It contains seventeen executable PQ2 product contracts, including independent identity and non-identity Clifford-string groups, and binds their scalable independent oracles, retired legacy identity/small timing provenance, and report-schema-30 independent-throughput timing only for the identity group. Runtime-group schema version 5 separately binds both groups to the source-owned optimization profiler note. Clean iterator, Pauli multiplication, transpose, and kernel evidence remains historical under its recorded inventories. No prior ratio or dirty optimization diagnostic is promoted under the refreshed inventory without a clean exact-group rerun.
...
## Source-Current All-Domain CQ2 Evidence
...
The source-current 271-parent checkpoint used these commands from clean revision `3f2f382627c8421de0a668819d467a9f252de20f`:
