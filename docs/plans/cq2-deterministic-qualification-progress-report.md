...
Current dependent performance inventory digest: `0ee3639389860799298164c94c647fcab45b03c9d67b941b1aad12c6e5e06df5`. It contains seventeen executable PQ2 product contracts, including independent identity and non-identity Clifford-string groups, and binds their scalable independent oracles, exact legacy identity/small replacement, and report-schema-30 independent-throughput timing only for the identity group. Runtime-group schema version 5 separately binds both groups to the source-owned optimization profiler note. Clean iterator, Pauli multiplication, transpose, and kernel evidence remains historical under its recorded inventories. No prior ratio or dirty optimization diagnostic is promoted under the refreshed inventory without a clean exact-group rerun.
