...
- Add rows `pf5-detecting-regions-repeat`, `pf5-missing-detectors-mpp`, `pf5-missing-detectors-generated-code`, `pf5-flow-solve-measurement-rich`, `pf5-flow-solve-measurement-python`, `pf5-has-all-flows-batch`, and `pf5-flow-generators-measurement-rich`.
