...
- Keep broader Stim `circuit_inverse_qec` cases such as `two_to_one`, `pass_through`, noisy measure-reset, `m_det`, `mzz`, `mpp`, and `obs_include_pauli` active for later PFM2 or PFM5 slices.
