...
- Missing-detector generated-code suffix analysis beyond the promoted honeycomb and toric cases is under-specified until exact generated families, suffix comparators, resource behavior, oracle metadata, and benchmark policy are selected; broader flow-dependent utility behavior remains active.
