...
> Source-current note, 2026-07-18: this report records CQ1 harness completion and historical evidence. Strengthening the dedicated Pauli iterator owner sets the source-current correctness digest to `4c940e983df10a7c95cc512939f4a0cce79f1865e141739af9378db581ea5f87`, with 580 implemented, 17 evidence-close, and 1,147 planned parents. Core revision `8503f458eac09fe94dba54cf8d6e16e88e195df4` provides the exact iterator corpus, clean evidence revision `afaf0bf7f236b9f6ae6f72c19bbbdfea94d26632` publishes its focused three-case evidence after complete accepted-maximum traversal strengthening, and clean revision `6351fe0a529462efd9f18a88bd59c08cfec9f81b` passes the latest complete historical 145-case PR subset and 271-case full and soak CQ2 selections with report replay and exact preflight under its recorded source. Controller hardening at `763b04055f969668a4152e019ed62a3555cd0476` makes a fresh source-current all-domain rerun necessary. See `docs/plans/cq2-deterministic-qualification-progress-report.md`.
