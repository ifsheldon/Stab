...
Current correctness dependency after the second DEM parser source refresh: schema-version-3 CQ0 semantic digest `e5635ca4a2c217ee79768d35336c50611a9f12f86edded8a7f01fce1ca72add4`.

Current schema-version-2 performance inventory digest after refreshing the unchanged DEM correctness parent source locations and updated profiler-note binding is `d27b71d205ec938a77c9981fb524e70c9b17eeafeadf3ade6367632aeb3b1693`. Runtime-group schema version 5 binds the DEM fixture identities, exact correctness parent, comparator sources, fixed scales, and independent `1.25x` gates while preserving the reviewed Clifford scalable oracles, normalized statistic, source-owned independent-throughput timing only for the identity group, and every checked legacy migration. The DEM contracts inherit no timing result into this inventory and remain executable but unqualified until their clean machine evidence and focused migration complete.
