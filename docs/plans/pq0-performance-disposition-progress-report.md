...
Current correctness dependency after the DEM parser source refresh: schema-version-3 CQ0 semantic digest `b9ed22cfcf637e740e68501b32b764015e937e6bc8d75ced3328f62ecc20cf40`.

Current schema-version-2 performance inventory digest after refreshing the unchanged DEM correctness parent source location is `acd913e0966b9968b24c06bd2fed678f4608f0ff1ab82735dab5ebc109f119b3`. Runtime-group schema version 5 binds the DEM fixture identities, exact correctness parent, comparator sources, fixed scales, and independent `1.25x` gates while preserving the reviewed Clifford scalable oracles, normalized statistic, source-owned independent-throughput timing only for the identity group, and every checked legacy migration. The DEM contracts inherit no timing result from preceding inventories and remain executable but unqualified until their clean machine evidence and focused migration complete.
