...
Current correctness dependency after the packed Clifford-string review fixes: schema-version-3 CQ0 semantic digest `648e7ea5a66997a810498dc871257bd654c7f9af9304651d43a88103eded0289`.

Current schema-version-2 performance inventory digest after adding independent direct DEM parse and canonical-print contracts to the reviewed Clifford and earlier product contracts: `8094995692c48c98723467cf6e90c3c685797fb4a02bf0efe15c273d844fbfef`. Runtime-group schema version 5 binds the DEM fixture identities, exact correctness parent, comparator sources, fixed scales, and independent `1.25x` gates while preserving the reviewed Clifford scalable oracles, normalized statistic, source-owned independent-throughput timing only for the identity group, and every checked legacy migration. The new DEM contracts inherit no timing result from preceding inventories and remain executable but unqualified until their clean machine evidence and focused migration complete.
