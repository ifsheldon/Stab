...
- Define the public API filter as default-feature reachable types, functions, constants, inherent methods, and explicitly implemented public traits; exclude compiler-generated auto or blanket implementation noise and reject qualification-only exports in every product build.
