...
Status: Exact source ownership is complete as of 2026-07-23 with 275 parents across the eight selected domains. The source-current correctness inventory is `592934174f3cf248553d3df67078ec00563e48acfd4c5ddf15cef44fd9b49fd0`, with 2,065 public API records and 1,757 evidence parents. The 43-parent result-format domain includes strict shared text grammars, typed DETS APIs, CLI propagation, file-role safety, and the checked differential corpus, but remains reopened until fresh PR, full, and soak execution runs from a clean committed revision. Clean revision `3f2f382627c8421de0a668819d467a9f252de20f` passed the PR tier's 145 selected parents and all 271 then-selected parents in both full and soak under preceding digest `4c940e983df10a7c95cc512939f4a0cce79f1865e141739af9378db581ea5f87`; every recorded accepted artifact remains valid only for its exact producer and inventory. Revision `80fb5405fb077c694a8a8a18e64a3a5831e20a5e` supplies historical focused DEM correctness evidence but cannot authorize current `raw-work-v2` timing. Current and historical execution, audit, and full-code-review evidence is recorded in [cq2-deterministic-qualification-progress-report.md](cq2-deterministic-qualification-progress-report.md) and the relevant PQ2 slice reports.
