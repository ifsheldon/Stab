...
| Flows | Partial | `Flow` and circuit flow-generator subsets are implemented for deterministic unitary and scoped M6 semantics. Full measurement-rich flow solving and Python API parity remain deferred. |
