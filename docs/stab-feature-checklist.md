...
| Programmatic mutation | Partial | `append_instruction`, `append_repeat_block`, and `clear` exist. Python-style `append_from_stim_program_text`, `insert`, `pop`, concatenation operators, file constructors, and complete ergonomic mutation parity are not implemented as public Rust APIs. |
