...
| Programmatic mutation | Partial with Rust mutation-helper subset | `append_instruction`, `append_repeat_block`, `append_from_stim_text`, `append_from_stim_program_text`, `append_circuit`, `concatenated`, `repeated`, `repeat_in_place`, derived `Clone`, and `clear` exist. Insert, pop, file constructors or writers, Python operator ergonomics, and complete ergonomic mutation parity are not implemented as public Rust APIs. |
