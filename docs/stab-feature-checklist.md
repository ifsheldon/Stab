...
| Programmatic mutation | Partial with Rust text-append subset | `append_instruction`, `append_repeat_block`, `append_from_stim_text`, `append_from_stim_program_text`, and `clear` exist. Insert, pop, concatenation and repetition operators, file constructors, and complete ergonomic mutation parity are not implemented as public Rust APIs. |
