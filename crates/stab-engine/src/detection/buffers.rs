...
pub(super) fn resource_amount(value: usize, context: &str) -> DetectionResult<u64> {
...
pub(super) fn validate_vector_capacity<T>(
    len: usize,
    context: &'static str,
) -> DetectionResult<()> {
...
pub(super) fn try_false_vec(len: usize, context: &'static str) -> DetectionResult<Vec<bool>> {
