...
use stab_analysis::{AnalysisResult, ErrorAnalyzerOptions, circuit_to_detector_error_model};
...
fn analyze_with_threshold(text: &str, threshold: f64) -> AnalysisResult<String> {
    let circuit = Circuit::from_stim_str(text).expect("circuit");
