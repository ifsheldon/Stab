...
impl Circuit {
    ...
    ///
    /// This includes `inverse_unitary` plus selected reset-measure-detector and
    /// measure-reset pass-through rewrites for one plain reset group, one
    /// matching measurement group, one optional matching measure-reset group, and
