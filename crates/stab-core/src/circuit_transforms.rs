...
impl Circuit {
    ...
    /// measurement case, selected bounded repeat-loop refolding, and a selected nested
    /// bounded-repeat detector-parity feedback case, and rejects excessive repeat work or
